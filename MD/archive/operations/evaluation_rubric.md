...
| **D3. Adherence to Standards (표준 준수)** | `MD/design_guide.md`, `MD/tech.md` 등 SSOT에 명시된 코딩 표준, 디자인 가이드, 아키텍처 원칙을 준수하는 정도. | 0.2 |
...
2.  **SSOT 검토:** 작업 관련 SSOT 파일 (`MD/about_pulse.md`, `MD/design_guide.md`, `MD/tech.md`)을 검토하여 작업의 맥락과 요구사항을 파악합니다.
